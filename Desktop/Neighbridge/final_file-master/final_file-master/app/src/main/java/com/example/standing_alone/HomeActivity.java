...
public class HomeActivity extends AppCompatActivity implements Overlay.OnClickListener, OnMapReadyCallback {
        ...
        write_new_text.findViewById(R.id.yesBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i=0; i < str.size(); i++) {
                    ...
                    marker.setOnClickListener(HomeActivity.this::onClick);
                    activeMarkers.add(marker);
